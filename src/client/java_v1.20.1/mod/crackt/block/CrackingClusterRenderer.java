...
public class CrackingClusterRenderer implements BlockEntityRenderer<CrackingClusterBlockEntity> {
	...
	@Override
	public void render(CrackingClusterBlockEntity cluster, float tickDelta, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
	...
	@Override
	public boolean shouldRenderOffScreen(CrackingClusterBlockEntity cluster) {
		return true;
	}
